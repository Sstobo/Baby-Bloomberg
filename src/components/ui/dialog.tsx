  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          variant === "terminal"
            ? "terminal bg-[var(--terminal-bg)] border border-[var(--terminal-divider)] text-[var(--terminal-text-primary)] data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 grid max-w-[calc(100%-2rem)] gap-4 rounded-lg p-0 text-sm duration-100 sm:max-w-2xl fixed top-1/2 left-1/2 z-50 w-full -translate-x-1/2 -translate-y-1/2 outline-none max-h-[80vh] overflow-hidden"
          ...
          <DialogPrimitive.Close asChild>
            <Button
              ...
              className={cn(
                ...
                variant === "terminal" && "text-[var(--terminal-text-muted)] hover:text-[var(--terminal-text-primary)] hover:bg-[var(--terminal-surface)]"
              )}
              size="icon-sm"
            >
